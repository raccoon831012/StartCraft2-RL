...
_MAP_NAME = 'DefeatZerglingsAndBanelings'
...
CMD = {0:_SELECT_ARMY,1:_SELECT_POINT,2:_ATTACK_SCREEN,3:_NO_OP}

class DefeatZerglingsAndBanelings1dEnv(BaseMovement1dEnv):
...
class DefeatZerglingsAndBanelings2dEnv(DefeatZerglingsAndBanelings1dEnv):
...
class DefeatZerglingsAndBanelings3dEnv(BaseMovement3dEnv):
    def __init__(self, **kwargs):
        super().__init__(map_name=_MAP_NAME, **kwargs)
